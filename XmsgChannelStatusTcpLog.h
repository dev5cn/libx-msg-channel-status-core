...
#ifndef XMSGCHANNELSTATUSTCPLOG_H_
#define XMSGCHANNELSTATUSTCPLOG_H_

#include <libx-msg-common-dat-struct-cpp.h>

class XmsgChannelStatusTcpLog: public XmsgImTcpLog
{
public:
...
public:
	XmsgChannelStatusTcpLog();
	virtual ~XmsgChannelStatusTcpLog();
};
